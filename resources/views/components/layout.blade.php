...
<body>
    {{-- <nav>
        ...
        <x-nav-link style="color:green" href="/contact">Contact</x-nav-link>
    </nav> --}}
    {{-- <?php echo $slot;?> --}}
    {{-- {{ $slot }} --}}
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                {{-- <a href="/" class="{{false ? 'bg-gray-300 text-white': 'text-gray-300 hover:bg-gray-700 hover:text-white' }}bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a> --}}
